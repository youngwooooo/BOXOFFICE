					...
					<form method="post" enctype="multipart/form-data"
						...
						<div class="col-sm-9">
							...
							<div class="form-group">
								...
								<div class="col-sm-10 form-inline">
									<input type="text" class="form-control" id="mvNameKor"
										name="mvNameKor" value="<%=movieVO.getMvNameKor()%>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10 form-inline">
									<input type="text" class="form-control" id="mvNameEng"
										name="mvNameEng" value="<%=movieVO.getMvNameEng()%>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10 form-inline">
									<input type="text" class="form-control" id="mvRelDate"
										name="mvRelDate" value="<%=movieVO.getMvRelDate()%>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10 form-inline">
									<input type="text" class="form-control" id="mvRatingCd"
										name="mvRatingCd" value="<%=movieVO.getMvRatingCd()%>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10 form-inline">
									<input type="text" class="form-control" id="mvRunningTime"
										name="mvRunningTime" value="<%=movieVO.getMvRunningTime()%>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10 form-inline">
									<input type="text" class="form-control" id="director"
										name="director" value="<%=movieVO.getDirector()%>"> <span
							...
							<div class="form-group">
								...
								<div class="col-sm-10 form-inline">
									<input type="text" class="form-control" id="actor" name="actor"
										value="<%=movieVO.getActor()%>"> <span id="actorSpan"></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10 form-inline">
									<input type="text" class="form-control" id="showYn"
										name="showYn" value="<%=movieVO.getShowYn()%>"> <span
										id="showYnSpan"></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10 form-inline">
									<textarea rows="5" cols="30"> <%=movieVO.getMvPlot()%></textarea>
							...
							<div class="form-group">
								...
								<div class="col-sm-10 form-inline">
									<input type="text" class="form-control" id="dubbingYn"
										name="dubbingYn" value="<%=movieVO.getDubbingYn()%>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10 form-inline">
									<input type="text" class="form-control" id="mvCompany"
										name="mvCompany" value="<%=movieVO.getMvCompany()%>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10 form-inline">
									<input type="text" class="form-control" id="mvCountry"
										name="mvCountry" value="<%=movieVO.getMvCountry()%>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10 form-inline">
									<input type="text" class="form-control" id="mvShowEndDate"
										name="mvShowEndDate" value="<%=movieVO.getMvShowEndDate()%>">
							...
							<div class="form-group">
								<label class="control-label col-sm-2" for="atchFile">첨부파일</label>
								...
								<div class="col-sm-10 form-inline">
									...
									<input type="text" class="form-control" id="atchFile"
										name="atchFile" value="<%=fileVO.getFileOrignName()%>">
