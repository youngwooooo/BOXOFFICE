...
public class FileUploadRequestWrapper extends HttpServletRequestWrapper {
	...
	public static final String UPLOAD_DIRECTORY = "d:/A_TeachingMaterial/4.MiddleProject/workspace/TicketingProject/WebContent/images/admin";			// 업로드 경로 설정
    ...
    /**
     * FileUploadRequestWrapper 클래스 여부를 체크하기 위한 유틸메서드.
     * @param request 요청객체
