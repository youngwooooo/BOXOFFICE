...
<title>박스오피스 | 공지사항 등록</title>
</head>
<body>
<%@include file="../../common/header.jsp" %>
	<div id="divPage">
	<form method="post" enctype="multipart/form-data" action="<%=request.getContextPath() %>/admin/insertNotice.do">
		<div id="title">
		...
		<table>
			...
			<tr>
				<th>BOARD CODE</th>
				<td>
					<textarea class="form-control" rows="1" name="boardCd" placeholder="BD01" id="code"></textarea>
				</td>
			</tr>
		</table>
		<div id="btn">
