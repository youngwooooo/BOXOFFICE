...
<%@include file="../../common/header.jsp" %>
	<div id="divPage">	
	<form method="post" enctype="multipart/form-data" action="<%=request.getContextPath() %>/admin/insertEvent.do">
		<div id="title">
		...
		<div id="table">
			<table>
				<tr>
					<th>POST CODE</th>
					<td><input type="text" class=col-sm-9 name="postCd" /></td>
				</tr>
				<tr>
					<th>이벤트 제목</th>
					<td><input type="text" class=col-sm-9 name="postTitle" /></td>
				</tr>
				<tr>
					<th>이벤트 내용</th>
					<td><textarea rows="9" class=col-sm-9 name="postContent" style="resize: none"></textarea></td>
				</tr>
				<tr>
					<th>BOARD CODE</th>
					<td><input id="code" class=col-sm-9 name="boardCd" placeholder="BD02"></td>
				</tr>
				<tr>
					<th>첨부파일</th>
