...
<!-- 							<th>조회수</th> -->
					...
					<%
						...
						<tr>
							...
							<td><a href="noticeDetail.do?postCd=<%=BoardList.get(i).getPostCd()%>"><%=BoardList.get(i).getPostTitle()%></a></td>
...
<%-- 							<td><%=BoardList.get(i).getPostView() %></td> --%>
			...
			<hr>
<!-- 			<div id="btn"> -->
<!-- 				<a href="insertNotice.do"><button type="submit" id=insertNT class="btn btn-danger"><span class="glyphicon glyphicon-pencil"></span>&nbsp;공지등록</button></a> -->
<!-- 			</div> -->
		</div>
		</div>
	</div>
