...
// 						//i가 data배열의 제일 마지막 데이터일 때 
				...
				var ticketingLink = "/TicketingProject/member/ticketing/ticketing.do"; 
				...
				for(var i=0 ; i<mvName.length; i++) {
					...
					while(j <= data.length-1) {
						if(mvName[i] == data[j].mvNameKor) {
							...
							var cinemaCdVal = $("#selCinema option:selected").val();
							var showDateVal = $("#selDate option:selected").val()
							
// 							str += "&nbsp;&nbsp;<a onclick=sendTicketingInfo(this)>" + data[j].showStartTime + "</a>&nbsp;&nbsp;|"
							str += "&nbsp;&nbsp;<a href= '/TicketingProject/member/ticketing/ticketing.do?cinemaCd=" + cinemaCdVal +"&showDate=" + showDateVal + "&mvNameKor="+ encodeURIComponent(mvName[i]) +"&showStartTime=" + data[j].showStartTime + "'>" + data[j].showStartTime + "</a>&nbsp;&nbsp;|"
		...
		// 데이터를 예매 페이지로 보내기
// 		function sendTicketingInfo(obj){
// 			var param = {
// 							cinemaCd : $("#selCinema option:selected").val()
// 						, showDate : $("#selDate option:selected").val()
// 						, mvNameKor : $(obj).parent().parent().children().eq(0).text()
// 						, showStartTime : $(obj).text()
// 						}

			
// 			$.ajax({
// 				url: "/TicketingProject/member/ticketing/ticketing.do"
// 				, data: param
// 				, type: "post"
// 				, dataType : "json"
// 				, success: function(data) {
						...
						<div>
							<table id="tbCinemaDate">
								<tr>
									<td><h6>극장정보</h6></td>
									<td>
										<select id="selCinema" name="cinemaCd">
									...
									<td><h6>상영일자</h6></td>
									<td>
										<select id="selDate" name="showDate">
