...
<head>
    ...
    <link rel="stylesheet" href="/TicketingProject/css/common/main/style.css">
                    ...
                    <div class="movie_chart">
                        <div class="chart_cont1">
                            <div>
                                <div class="poster">
                                    <figure>
                                        <img src="/TicketingProject/images/common/main/MP_balsin.jpg" srcset="/TicketingProject/images/common/main/MP_balsin.jpg 2x"  alt="침묵">
                                    </figure>
                                </div>
                                <div class="infor">
                                    <div class="infor_btn">
                            ...
                            <div>
                                <div class="poster">
                                    <figure>
                                        <a href="/TicketingProject/jsp/member/category/detailcategory.jsp"><img src="/TicketingProject/images/common/category/2.jpg" srcset="/TicketingProject/images/common/category/2.jpg 2x"  alt="침묵" style="height: 467.2px;"></a>
                                    </figure>
                                </div>
                                <div class="infor">
                                    <div class="infor_btn">
                            ...
                            <div>
                                <div class="poster">
                                    <figure>
                                        <img src="/TicketingProject/images/common/main/MP_killerBodyguard.jpg" srcset="/TicketingProject/images/common/main/MP_killerBodyguard.jpg 2x"  alt="침묵">
                                    </figure>
                                </div>
                                <div class="infor">
                                    <div class="infor_btn">
                            ...
                            <div>
                                <div class="poster">
                                    <figure>
                                        <img src="/TicketingProject/images/common/main/MP_cruella.jpg" srcset="/TicketingProject/images/common/main/MP_cruella.jpg 2x"  alt="침묵">
                                    </figure>
                                </div>
                                <div class="infor">
                                    <div class="infor_btn">
                        ...
                        <div class="chart_cont2">
                            <div>
                                <div class="poster">
                                    <figure>
                                        <img src="/TicketingProject/images/common/main/MP_cashTruck.jpg" srcset="/TicketingProject/images/common/main/MP_cashTruck.jpg 2x"  alt="침묵">
                                    </figure>
                                </div>
                                <div class="infor">
                                    <div class="infor_btn">
                            ...
                            <div>
                                <div class="poster">
                                    <figure>
                                        <img src="/TicketingProject/images/common/main/MP_luca.jpg" srcset="/TicketingProject/images/common/main/MP_luca.jpg 2x"  alt="침묵">
                                    </figure>
                                </div>
                                <div class="infor">
                                    <div class="infor_btn">
                            ...
                            <div>
                                <div class="poster">
                                    <figure>
                                        <img src="/TicketingProject/images/common/main/MP_girlSchool.jpg" srcset="/TicketingProject/images/common/main/MP_girlSchool.jpg 2x"  alt="침묵">
                                    </figure>
                                </div>
                                <div class="infor">
                                    <div class="infor_btn">
                            ...
                            <div>
                                <div class="poster">
                                    <figure>
                                        <img src="/TicketingProject/images/common/main/MP_conjuring3.jpg" srcset="/TicketingProject/images/common/main/MP_conjuring3.jpg 2x" alt="침묵">
                                    </figure>
                                </div>
                                <div class="infor">
                                    <div class="infor_btn">
                        ...
                        <div class="chart_cont3">
                            ...
                            <div>
                                <div class="poster">
                                    <figure>
                                        <img src="/TicketingProject/images/common/main/MP_quietPlace.jpg" srcset="/TicketingProject/images/common/main/MP_quietPlace.jpg 2x"  alt="침묵">
                                    </figure>
                                </div>
                                <div class="infor">
                                    <div class="infor_btn">
                ...
                <div class="event">
                    ...
                    <div class="event_left">
                        <div class="event_slider">
                            <a href="/TicketingProject/jsp/member/Event/detailEvent.jsp"><img src="/TicketingProject/images/common/event/detailEventMain.jpg" srcset="/TicketingProject/images/common/main/event01@2.jpg 2x" alt="시티 패키지"></a>
                        </div>
                        <figure class="event_box1">
                            <a href="#"><img src="/TicketingProject/images/common/main/event02.jpg" srcset="/TicketingProject/images/common/main/event02@2.jpg 2x" alt="남포항점 2019 시즌할인권"></a>
                        </figure>
                        <figure class="event_box2">
                            <a href="#"><img src="/TicketingProject/images/common/main/event03.jpg" srcset="/TicketingProject/images/common/main/event03@2.jpg 2x" alt="설 선물 이수점 전용 관람권 런칭"></a>
                        </figure>
                    </div>
                    <figure class="event_right">
                         <a href="#"><img src="/TicketingProject/images/common/main/event04.jpg" srcset="/TicketingProject/images/common/main/event04@2.jpg 2x" alt="사표 대신 영화표"></a>
                    </figure>
                </div>
            </div>
        </div>
...
<footer id="footer">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer_infor">
                        ...
                        <address>
                            <p>서울특별시 강남구 도산대로 156, 2층 박스오피스(주) (논현동, 중앙엠앤비사옥)<br><span class="bar2">대표자명 이영우</span><br><span class="bar2">사업자등록번호 211-86-59478</span> 통신판매업신고번호 제 833호</p>
                            <p>Copyright 2014 by BoxofficeJoo Inc. All right reserved</p>
                        </address>
                    </div>
                </div>
            </div>
    ...
    <!-- 자바스크립트 라이브러리 -->
    <script src="/TicketingProject/js/common/main/jquery.min_1.12.4.js"></script>
    <script src="/TicketingProject/js/common/main/modernizr-custom.js"></script>
    <script src="/TicketingProject/js/common/main/ie-checker.js"></script>
    <script src="/TicketingProject/js/common/main/swiper.min.js"></script>
    <script src="/TicketingProject/js/common/main/iframe_api.js"></script>
    <script src="/TicketingProject/js/common/main/movie.js"></script>
    <script>
        //배너 이미지 슬라이드
