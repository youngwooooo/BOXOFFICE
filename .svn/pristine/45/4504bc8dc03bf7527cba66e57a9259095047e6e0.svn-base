				...
				<div class="row">
					...
					<form method="post" enctype="multipart/form-data"
						...
						<div class="col-sm-9">
							...
							<div class="form-group">
								<label class="control-label col-sm-2" for="groupCd">장르</label>
								<div class="col-sm-10 form-inline">
									<input type="text" class="form-control" id="groupCd"
										readonly="readonly" name="groupCd" value="<%=movieVO.getGroupCd()%>">
									<span id="mvShowEndDateSpan"></span>
								</div>
							</div>
