...
public class detailNoticeHandler implements CommandHandler{
	
//	private static final String VIEW_PAGE = "/jsp/admin/board/detailNotice.jsp";
	private static final String VIEW_PAGE = "/jsp/admin/board/noticeDetail.jsp";
