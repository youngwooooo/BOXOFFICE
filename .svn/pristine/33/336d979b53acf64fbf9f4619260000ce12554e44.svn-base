...
import member.category.dao.IMovieDao;
import member.category.dao.MovieDaoImpl;
...
public class MovieServiceImpl implements IMovieService {
	...
	@Override
	public List<AtchMovieVO> getAllMovieList(MovieVO movieVO) {
		
		List<AtchMovieVO> movieList = new ArrayList<AtchMovieVO>();
		
		try {
			movieList = movieDao.getAllMovieList(smc, movieVO);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
