...
<% %>
			...
			<br><br>
			<div id="btn">
				<a href="updateNotice.do?postCd=<%=postVO.getPostCd()%>"><button type="button" id=updateNT><span class="glyphicon glyphicon-pencil"></span>수정</button></a>
				<a href="deleteNotice.do?postCd=<%=postVO.getPostCd()%>"><button type="button" id=deleteNT><span class="glyphicon glyphicon-trash"></span>삭제</button></a>
				<a href="mainBoard.do"><button type="button" id=backBoard><span class="glyphicon glyphicon-tasks"></span>목록</button></a>
			</div>
		</form>
		<br><br><br>
